...
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_11, "len(a) == L string modified while iterating over it", 51);
...
N_NIMCALL(NIM_BOOL, nsuIsSpaceAsciiChar)(NIM_CHAR c) {
	NIM_BOOL result;
	nimfr_("isSpaceAscii", "strutils.nim");
{	result = (NIM_BOOL)0;
	nimln_(97, "strutils.nim");
...
N_NIMCALL(NIM_BOOL, nsuIsNilOrWhitespace)(NimStringDesc* s) {
	NIM_BOOL result;
	nimfr_("isNilOrWhitespace", "strutils.nim");
{	result = (NIM_BOOL)0;
	{
		...
		L = (s ? s->Sup.len : 0);
		{
			while (1) {
				...
				i += ((NI) 1);
				{
					...
					failedAssertImpl_aDmpBTs9cPuXp0Mp9cfiNeyA(((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_11));
				}
				LA15_: ;
			} LA7: ;
		}
...
N_NIMCALL(void, nsuRemoveSuffixString)(NimStringDesc** s, NimStringDesc* suffix) {
	...
	nimln_(2295, "strutils.nim");
	newLen = ((*s) ? (*s)->Sup.len : 0);
	nimln_(2296, "strutils.nim");
	{
		NIM_BOOL T3_;
		...
		if (!T3_) goto LA4_;
		nimln_(2297, "strutils.nim");
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_13 = subInt(newLen, (suffix ? suffix->Sup.len : 0));
		newLen = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_13);
		nimln_(2298, "strutils.nim");
